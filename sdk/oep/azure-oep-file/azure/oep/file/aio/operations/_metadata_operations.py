...
from ...operations._metadata_operations import build_get_file_metadata_by_id_request, build_post_files_metadata_request
T = TypeVar('T')
...
class MetadataOperations:
    ...
    async def post_files_metadata(
        ...
        **kwargs: Any
        ...
        request = build_post_files_metadata_request(
            content_type=content_type,
            data_partition_id=data_partition_id,
            frame_of_reference=frame_of_reference,
            json=_json,
            template_url=self.post_files_metadata.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    post_files_metadata.metadata = {'url': "/api/file/v2/files/metadata"}  # type: ignore
    ...
    async def get_file_metadata_by_id(
        ...
        **kwargs: Any
        ...
        request = build_get_file_metadata_by_id_request(
            id=id,
            data_partition_id=data_partition_id,
            frame_of_reference=frame_of_reference,
            template_url=self.get_file_metadata_by_id.metadata['url'],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_file_metadata_by_id.metadata = {'url': "/api/file/v2/files/{id}/metadata"}  # type: ignore
