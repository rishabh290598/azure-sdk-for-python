...
from ...operations._location_operations import build_get_location_file_request
T = TypeVar('T')
...
class LocationOperations:
    ...
    async def get_location_file(
        ...
        **kwargs: Any
        ...
        request = build_get_location_file_request(
            data_partition_id=data_partition_id,
            frame_of_reference=frame_of_reference,
            template_url=self.get_location_file.metadata['url'],
            headers=_headers,
            params=_params,
        )
    ...
    get_location_file.metadata = {'url': "/api/file/v2/files/uploadURL"}  # type: ignore
